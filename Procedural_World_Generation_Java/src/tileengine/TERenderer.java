...
public class TERenderer {
    ...
    public void drawSquare(TETile[][] world, int[] pos) {
        for (int x = 0; x < 3; x++) {
            for (int y = 0; y < 3; y++) {
                if ((pos[0] + x) < world.length && (pos[0] - x) >= 0 && (pos[1] + y) < world[0].length && (pos[1] - y) >= 0 ) {
                    world[pos[0] + x][pos[1] + y].draw((pos[0] + x), (pos[1] + y));
                    world[pos[0] + x][pos[1] - y].draw((pos[0] + x), (pos[1] - y));
                    world[pos[0] - x][pos[1] - y].draw((pos[0] - x), (pos[1] - y));
                    world[pos[0] - x][pos[1] + y].draw((pos[0] - x), (pos[1] + y));
                }
