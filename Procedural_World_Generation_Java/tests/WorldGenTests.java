...
public class WorldGenTests {
    ...
    public void basicTest() {
        ...
        TETile[][] tiles = AutograderBuddy.getWorldFromInput("N7176832S");
    ...
    public void basicSaveTest() {
        ...
        AutograderBuddy.getWorldFromInput("n12233swwwasd:qwasd");
        TETile[][] tiles = AutograderBuddy.getWorldFromInput("lwwasd");
        TERenderer ter = new TERenderer();
        ter.initialize(tiles.length, tiles[0].length);
        ter.renderFrame(tiles);
        StdDraw.pause(5000);
